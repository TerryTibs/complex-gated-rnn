...
class DynamicHierarchicalVQ(nn.Module):
    ...
    def __init__(self, latent_dim, n_symbols, n_concepts):
        ...
        # Codebooks (Centroids in the latent space)
    ...
    def quantize(self, z_flat, codebook):
        ...
        # Straight-Through Estimator (Gradients flow through, values snap)
...
def train_model():
    ...
    for epoch in range(CONFIG["epochs"]):
        ...
        for i in range(len(data_tensor) - CONFIG["seq_len"] - 1):
            ...
            # Detach memory to prevent infinite BPTT growth
            ...
            # Pass cloned list of detached states
...
def generate_text(model, start_str="True"):
    ...
    # Graph to track Symbol -> Concept mappings
